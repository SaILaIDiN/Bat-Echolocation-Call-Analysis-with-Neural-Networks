""" This script is for an automated model training. For check_years_multi.py.
...
if __name__ == '__main__':
    ...
    from supervised_analysis.check_years_multi import bat_dataset_01, bat_dataset_02, bat_dataset_03, bat_dataset_04, \
        bat_dataset_05, bat_dataset_06, bat_dataset_07, bat_dataset_08, n_classes, bat_class_list, bat_dataset_FULL
                            ...
                            for weight_decay in list_weight_decay:
                                for dropout in list_dropout:
                                    ...
                                    train_net_auto(args_train, model_type, dataset[0:3], device, n_classes=n_classes,
                                                   class_mode="multi", species_or_genus="genus",
